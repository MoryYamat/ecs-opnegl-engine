...
void Model::loadModel(std::string const& filepath)
{
	...
	// console
	std::cout << "[Model] Loaded" << meshes.size() << "mesh" << std::endl;
...
// stb_image.h: だから、const char* path
unsigned int Model::TextureFromFile(const char* filepath, const std::string& directory, bool gamma)
{
